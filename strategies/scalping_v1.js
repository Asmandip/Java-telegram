// strategies/scalping_v1.js
// simple scalping style checks (3-min candles). Returns candidate object or null.

exports.name = 'scalping_v1';
exports.info = { author: 'asman', desc: 'Scalping: RSI + EMA confirmation + volume' };
...
exports.evaluate = async function(symbol, candles, settings = {}) {
  // candles: array of {time,open,high,low,close,vol}
  ...
  const confs = [];
  if (r !== null) {
    if (r < 35) confs.push('RSI_BUY');
    if (r > 65) confs.push('RSI_SELL');
  }
  if (e9 !== null && e21 !== null) {
    if (e9 > e21) confs.push('EMA_BULL'); else confs.push('EMA_BEAR');
  }
